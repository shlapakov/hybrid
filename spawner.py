...
from utilities.constants import hide_menu_style
...
class Spawner:
    ...
    def get_counter(self):
        ...
        st.markdown(
            f'<h2><a href="data:file/scr;base64,{b64}" download="script.scr"> Загрузить скрипт</a></h2>',
